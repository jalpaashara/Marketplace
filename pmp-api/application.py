...
@application.route('/product/<int:productId>/image', methods=['POST'])
...
@application.route('/user/<int:userId>/favProduct/<int:productId>', methods=['GET', 'POST', 'DELETE'])
...
@application.route('/user/<int:userId>/favProducts', methods=['GET'])
